...
def process_frame(frame, model, class_names):
    ...
    for i, (box, score, class_id) in enumerate(zip(boxes, scores, class_ids)):
        ...
        # Vẽ bounding box
        cv2.rectangle(frame, (xmin, ymin), (xmax, ymax), (0, 255, 0), 2)  # 0 255 0 là vẽ màu xanh với độ dày 2 pixel
...
if __name__ == "__main__":
    video_path = 'vdtest/vdtest.mp4'  # Đường dẫn tới video đầu vào
    output_path = 'processed_video/processed_video.avi'  # Đường dẫn tới video đầu ra
